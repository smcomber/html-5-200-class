...
function buildThumbnails()
{
  ...
  //for in loop
	for(i in imageListA)
	{
	   ...
	   output +=  imageListA[i][0];	//outputs label (first item in array)
      output += '<img src="' + imageListA[i][1] + '" />'; //outputs image path
	}
